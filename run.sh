...
# base run
torchrun --standalone --nnodes 1 --nproc_per_node 2 train.py --exp_id base_pde_heat_512_5 --data_loss_weight 5.0 --max_epoch 40 &&
...
torchrun --standalone --nnodes 1 --nproc_per_node 2 train.py --exp_id base_pde_heat_512_3 --data_loss_weight 3.0 --max_epoch 40 &&
...
torchrun --standalone --nnodes 1 --nproc_per_node 2 train.py --exp_id base_pde_heat_512_2 --data_loss_weight 2.0 --max_epoch 40 &&
